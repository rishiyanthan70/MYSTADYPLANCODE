...
class StudyPlanApp {
  ...
  attachListeners() {
    ...
    document.getElementById('clearNonCompletedBtn').addEventListener('click', () => {
      ...
      if (confirm(`Are you sure you want to delete ${nonCompleted.length} non-completed task(s)? This action cannot be undone.`)) {
    ...
    document.getElementById('clearCompletedBtn').addEventListener('click', () => {
      ...
      if (confirm(`Are you sure you want to delete ${completed.length} completed task(s)? This action cannot be undone.`)) {
        this.tasks = this.tasks.filter(t => !t.completed || (this.selectedGroupId && t.groupId !== this.selectedGroupId));
        this.saveData();
        this.renderTasks();
        this.notify('🗑️ Tasks cleared!');
  ...
  deleteGroup(id) {
    ...
    if (group && confirm(`Are you sure you want to delete "${group.name}" and all its plans? This action cannot be undone.`)) {
